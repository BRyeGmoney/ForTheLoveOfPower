...
namespace PenisPotato.StateSystem.Networking
{
    ...
    class NetworkSessionComponent : GameComponent
    {
        ...
        /// </summary>
        NetworkSessionComponent(StateManager screenManager,
                                NetworkSession networkSession)
        ...
        /// </summary>
        public static void Create(StateManager screenManager,
                                  NetworkSession networkSession)
        {
        ...
        /// </summary>
        public static void InviteAccepted(StateManager screenManager,
        ...
        {
            StateManager screenManager = ((GameScreen)sender).ScreenManager;
        ...
        /// </summary>
        public static void LeaveSession(StateManager screenManager,
                                        PlayerIndex playerIndex)
        {
            NetworkSessionComponent self = FindSessionComponent(screenManager.Game);
